 ...
 * @returns {*}
 */
export const environmentConfig = function (config) {
    if (process.env.NODE_ENV === 'development') {
        return configDetail[config].dev;
    } else if (process.env.NODE_ENV === 'production' && process.env.VUE_APP_FLAG === 'test') {
        return configDetail[config].test;
    } else if (process.env.NODE_ENV === 'production' && process.env.VUE_APP_FLAG === 'pre') {
        return configDetail[config].pre;
    } else {
        return configDetail[config].pro;
    }
};
