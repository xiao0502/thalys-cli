    ...
    <Layout style="height: 100%" class="main">
        ...
        >
            ...
            >
                ...
                <div class="logo-con">
                    <div class="max-logo" @click="$router.push('home')">
                        <img :src="maxLogo" />
                        <div class="text" v-show="!collapsed"> 塞力斯后台管理系统 </div>
                    </div>
                </div>
            </side-menu>
        </Sider>
...
export default {
    ...
    data() {
        return {
            collapsed: false,
            isFullscreen: false,
            maxLogo: require('../../assets/images/icon-logo.png')
        };
    },
    computed: {
        ...mapGetters(['errorCount', 'currentOrganization']),
        tagNavList() {
